...
WebUI.callTestCase(findTestCase('DemoTests/Login'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Object Repository/Page_Dashboard  nopCommerce administration/p_Promotions'))
